        ...
        <div className='container' style={{ height: "auto " }}>
          ...
          >
            ...
            <div id='content' style={{ height: "auto" }}>
              ...
              <p>
                {" "}
                autoplace is committed to ensuring that the app is as useful and
              ...
              <p>
                {" "}
                The autoplace app stores and processes personal data that you
                ...
                security features and it could mean that the autoplace app won’t
              ...
              <p>
                {" "}
                You should be aware that there are certain things that autoplace
                ...
                provider, but autoplace cannot take responsibility for the app
              ...
              <p>
                {" "}
                Along the same lines, autoplace cannot always take
                ...
                and you can’t turn it on to avail the Service, autoplace cannot
                accept responsibility.{" "}
              </p>{" "}
              <p>
                {" "}
                With respect to autoplace’s responsibility for your use of the
                ...
                autoplace accepts no liability for any loss, direct or indirect,
              ...
              <p>
                ...
                autoplace does not promise that it will always update the app so
              ...
              <p>
                {" "}
                These terms and conditions are effective as of 2022-05-23{" "}
              </p>{" "}
              <p>
