...
import {
  ...
  // v1 
  ParamsAccount, Add_Admin, AppAllUsers, AppVehiclesCategories, AppBlockedUsers, AppVehiclesFamilies, AppVehicle, Delete_Params
} from '../pageListAsync';
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        <Route path="/app/pages/delete_params" component={Delete_Params} />
