...
import { closeMsgAction, confirmPhone, resendPhone } from "../../redux/actions/authActions_v1"
    ...
    return (
        <Paper className={classes.sideWrap}>
            ...
            <div className={classes.topBar}>
                ...
                <Link to='/'>
                    <Button size="small" className={classes.buttonLink} to="/">
            ...
            {
                messagesAuth !== null && messagesAuth.typeAuth === "confirm-phone"
                    ? (
                        <MessagesForm
                            variant="error"
                ...
                <form onSubmit={e => {
                    ...
                    <div style={{ marginTop: "4rem" }} >
                        ...
                        <div className={classes.btnArea}>
                            <Button variant="outlined" fullWidth color="primary" size="large" onClick={() => resendPhone(token)}>
                                Resend Code
                            </Button>
                        </div>
...
const mapDispatchToProps = {
    closeMsgAction, confirmPhone, resendPhone
};
