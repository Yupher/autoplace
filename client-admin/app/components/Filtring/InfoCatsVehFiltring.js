...
import { setDisplayVehCats, setFilterVehCats } from '../../redux/actions/infoVehActions'

const InfoCatsVehFiltring = (props) => {

    const { classes, setDisplayVehCats, setFilterVehCats } = props;

    const [display, setDisplay] = useState("normal");
    const [filter, setFilter] = useState("cars");

    useEffect(() => {
        setDisplayVehCats(display)
    }, [display]);

    useEffect(() => {
        setFilterVehCats(filter)
    }, [filter]);
...
InfoCatsVehFiltring.propTypes = {
    ...
    setDisplayVehCats: PropTypes.func.isRequired,
    setFilterVehCats: PropTypes.func.isRequired,
...
const mapDispatchToProps = { setDisplayVehCats, setFilterVehCats };
